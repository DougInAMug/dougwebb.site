...
### 3.1 Seeing like a state machine[^slasm]
...
[^slasm] This a half-joke made after James C. Scott's _Seeing like a state_. He looks at how nation states' efforts to control their domain has typically lead them to try and standardise things, including their subjects, often with significant coercion. Considering a position system as a state machine could induce a desire to simplify things.