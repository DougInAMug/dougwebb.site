...
This is definitely better than copy-pasting, but:
1. it is not encrypted, meaning anyone with access to the drive can read my data 
2. it takes quite a lot of time
3. it gives only one monolithic backup, meaning I only have the option of reverting to the last backup.
